...
flags.DEFINE_string('output', './checkpoints_20220728/yolov4', 'path to output')
flags.DEFINE_string('output_best', './checkpoints_20220728_best/yolov4-best', 'path to output')
...
flags.DEFINE_string('annotation_path', r'C:\YOLOV4-TF\datasets\factory_data_val_blur9_20220728_small.txt', 'path to output')
...
def main(_argv):
    ...
    #def main(INPUT_SIZE=640):
        ...
        print('ground_truth_record:')
        for i in range(len(ground_truth_record)):
            print(ground_truth_record[i])
        '''

        '''    
        print('predict_record')
        for i in range(len(predict_record)):
            print(predict_record[i])
    ...
    for epoch in range(first_stage_epochs + second_stage_epochs):
        ...
        if DO_TRAIN:
            print("")
            print("---------------------------------------------------------------------------------------------")
            print('{}{:8}{}{:8}{}{:8}{}{:8}{}{:8}{}'.format('Epoch','','Total_loss','','box','','obj','','cls','','img_size'))
        ...
        if DO_VAL:
            ...
            print('{:10} {:10} {:10}  {:10}'.format('Total_loss','box','obj','cls'))
            print('     ------------------------------------------------------------')
        ...
        if (epoch+1)>=1:
            ...
            print(PREFIX)
        import csv
        result_path = './checkpoints_yolov4_20220806_ciou_tf25_mosaic_aug/result.txt'
